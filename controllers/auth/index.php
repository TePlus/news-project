...
<div class="wrapper">
    <div class="header header-filter"
         style="background-image: url('<?= WEB_META_BASE_URL ?>img/city.jpg'); background-size: cover; background-position: top center;">
            ...
            <div class="row vertical-center-row">
                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                    <div class="card card-signup">
                        <form class="form" id="form" data-toggle="validator" novalidate="novalidate" method="POST"
                            ...
                            <div class="footer text-center">
                                <button class="btn btn-primary" type="submit" id="btn-login">LOGIN
